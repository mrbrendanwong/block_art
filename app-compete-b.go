...
func main() {
	...
	// Draw line 1.
	_, _, _, err = canvas.AddShape(validateNum, blockartlib.PATH, "M 550 800 v -100 0", "transparent", "blue")
	if checkError(err) != nil {
		return
	}
	...
	// Draw line 2.
	_, _, _, err = canvas.AddShape(validateNum, blockartlib.PATH, "M 700 800 v -100 0", "transparent", "red")
	if checkError(err) != nil {
		return
	}
	...
	// Draw line 3.
	_, _, _, err = canvas.AddShape(validateNum, blockartlib.PATH, "M 850 800 v -100", "transparent", "blue")
	if checkError(err) != nil {
		return
	}
